...
my $SVM_Prediction_Results = "D:\\izzebot\\Documents\\Final Project\\tf_idf_test_predictions";
...
#Step 3: Train SVMmulticlass;
	#system("svm_multiclass_learn -c .5 Training_Feature_Vectors.dat tfidf_model");
	system("svm_learn Training_Feature_Vectors.dat tfidf_model");	
#Step 4: Classify Queries with SVMmulticlass;
	#system("svm_multiclass_classify Query_Feature_Vectors.dat tfidf_model tf_idf_test_predictions");
	system("svm_classify Query_Feature_Vectors.dat tfidf_model tf_idf_test_predictions");
